 ...
 * Student 3: Shadman Zahir - 025405651
 * April 23, 2022
...
public class Main {
    ...
    while(true){
      if(tempChar == 'n'){
        ...
        if(h.hasKey()){
          ...
          System.out.println("You do not have a key. You must either find one or buy one. Otherwise, this is the end of your journey.");
          break;
        }
      }
      else if(tempChar == 'i'){
  ...
  /** monsterRoom creates the menu when the hero faces an enemy and calls the movement methods allowing the hero to move anywhere
  ...
  */
  ...
  /** store Creates the store allowing our hero to purchase keys and potions for a cost of the gold they've earned
